...
import {DEFAULT_ANNOTATIONS} from '@sanity/schema'
import {DEFAULT_DECORATORS} from '@sanity/schema'
 ...
 * @beta
 */
export declare type AssetAccessPolicy = 'checking' | 'private' | 'public' | 'unknown'
 ...
 * @public
 */
export declare interface DecorationMember {
  kind: 'decoration'
  key: string
 ...
 * @hidden
 * @public */
export declare type FieldsetMembers = FieldMember | FieldError | DecorationMember

/**
 * @hidden
 * @public
 */
export declare type FieldsetRenderMembersCallback = (
...
/** @public */
export declare type ObjectMember = FieldMember | FieldSetMember | FieldError | DecorationMember
 ...
 * @hidden
 * @public */
export declare type ObjectRenderMembersCallback = (members: ObjectMember[]) => ObjectMember[]
