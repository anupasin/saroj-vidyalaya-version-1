    ...
    <footer className="bg-gray-800 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              A tribute to Saroj and her belief that education should illuminate rather than intimidate. Join us in making learning accessible, engaging, and meaningful for every student.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/anupamsingh0810" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/birupia/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-brand-gold transition-colors" 
          ...
          <div className="md:ml-auto md:max-w-md">
            <h3 className="text-lg font-semibold mb-4 font-nunito">Contact Us</h3>
        ...
        <div className="border-t border-gray-700 pt-8">
          <p className="text-center text-gray-400 font-nunito">
            &copy; {new Date().getFullYear()} Saroj Vidyalaya. All rights reserved. Created in memory of Saroj.
          </p>
        </div>
      </div>
    </footer>
